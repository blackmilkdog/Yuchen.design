...
export default function NoviBoxCaseStudy() {
  return (
    <main className="relative min-h-screen bg-white text-gray-900">
      ...
      {/* --- Hero Header --- */}
      <header className="relative overflow-hidden border-b border-gray-100 px-8 lg:px-16">
        {/* Hero glow orbs */}
      ...
      {/* --- Impact Metrics --- */}
      <section className="border-b border-gray-100 px-8 lg:px-16">
      ...
      {sections.map((s, i) => (
        <section
          key={s.num}
          className="border-b border-gray-100 px-8 lg:px-16"
        >
          <div className="mx-auto max-w-[1200px] py-16 lg:py-24">
            ...
            >
              <div className="flex items-start gap-6 lg:gap-12">
                {/* Section number */}
                <span className="hidden shrink-0 font-mono text-[80px] leading-none text-gray-100 lg:block lg:text-[120px]">
                  {s.num}
                </span>
      ...
      <section className="px-8 lg:px-16">
        <div className="mx-auto max-w-[1200px] py-16 lg:py-24">
          <motion.div
            ...
            viewport={{ once: true, margin: "-80px" }}
            transition={{ duration: 0.7, ease }}
            className="relative overflow-hidden rounded-3xl border border-gray-200 bg-gradient-to-br from-accent/5 via-gray-50 to-accent-secondary/5 p-10 backdrop-blur-sm lg:p-16"
          >
            {/* Decorative glow */}
      ...
      {/* --- Takeaways --- */}
      <section className="border-t border-gray-100 px-8 lg:px-16">
        <div className="mx-auto max-w-[1200px] py-16 lg:py-24">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
